...
public class TimeUtil {
	...
	public final static String FORMAT_AUTO_NUMBER = "yyyyMMdd-HHmmss";
	public final static String FORMAT_AUTO_NUMBER_Str = "(yyyy)MMddHHmmss";

	public final static String FORMAT_DATE = "yyyy-MM-dd";
	public final static String FORMAT_MYDATE = "yyyyMMdd";
	...
	public static String getTimeMillis(){
		...
		String timeMillis = timeFormatter.format(new Date(time));
		return timeMillis;
	}
