...
public class SeaAmoyActivity extends BaseAppActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_sea_amoy_web;
    }
    ...
    protected void initView() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                L.e("seaamoy==="+url);
                L.e("seaamoyview==="+view.getUrl());

                if(url.contains("https://open.macaumarket.com/macaumarketH5/index.html")|url.contains("https://open.macaumarket.com/macaumarketH5/shopping_cart.html")){
